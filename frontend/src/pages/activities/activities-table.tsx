...
const ActivitiesTablesPage = () => {
  ...
  const [filters] = useState([{label: 'ActivityType', title: 'activity_type'},

          {label: 'Emissions(kgCO2)', title: 'emissions', number: 'true'},
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/activities/activities-new'} color='info' label='New Item' />
